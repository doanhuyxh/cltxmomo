                ...
                if (data.status == true) {
                    ...
                    if (data.data_momo) {
                        ...
                        for (let momo of data.data_momo) {
                            ...
                            table_one += `<tr>`;
                            table_one += `<td>${momo.username} <span class="label label-success text-uppercase" onclick="DUNGA.coppy('${momo.username}')"><i class="fa fa-clipboard" aria-hidden="true"></i></span></td>`;
                            table_one += `<td>${status_label}</td>`;
                            table_one += `<td><strong><span class="text-danger">Không giới hạn</span></strong></td>`;
                            table_one += `<td><strong><span class="text-danger cash-format">${nFormatter(
                ...
                if (data.status == true) {
                    if (data.history.status == true) {
                        ...
                        for (let history of data.history.data) {
                            ...
                            // html_history += `<td>${history.tranId}</td>`;
                            ...
                            html_history += `<td><span class="label label-info">${history.comment}</span></td>`;

                            html_history += `<td>${status_win[history.victory]
                                }</td>`;
                            html_history += "</tr>";
                            if (
                ...
                if (data.status == true) {
                    if (data.data.status == true) {
                        ...
                        $(".ntmsg").html(`
                            ...
                            <div class="st"><b class="text-warning">Lá»i nháº¯n: ${data_response.comment
                            }</b></div>`);
                    }
                } else {
